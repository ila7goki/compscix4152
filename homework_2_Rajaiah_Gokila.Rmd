...
```{r, fig.cap="Line chart using geom_line (displ vs hwy)", fig.align='center'}
...
3. Show.legend includes the legend associated with that geom' layer. By default if there's any aesthetics are mapped for a geom layer, legend is included. In the above chart legend is included showing the mark for both point & line.
If show.legend is set to False it will not display the legend associated with that particular layer' aestheic mapping.
Example below shows both geom layer' legend is set to False. 
...
```{r, fig.cap="geom_bar vs geom_col", fig.align='center'}
